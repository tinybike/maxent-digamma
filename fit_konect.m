...
datafile = {'opsahl-openflights', 'lasagne-spanishbook', 'enron',...
    ...
    'petster-friendships-dog', 'wikipedia-growth', 'opsahl-collaboration',...
    'flickr-growth', 'wordnet-words', 'patentcite',...
    'wikisigned-k2', 'escorts', 'escorts',...
    'ego-twitter', 'loc-brightkite_edges', 'dbpedia-producer',...
    'opsahl-ucforum', 'dbpedia-writer', 'edit-enwikiquote',...
    'bibsonomy-2ti', 'citeulike-ut'};
fig_title = {'Airports', 'Spanish word adjacency', 'Enron emails',...
    ...
    'Dogster', 'Wikipedia links', 'Condensed matter authorship',...
    'Flickr', 'Wordnet', 'U.S. patents',...
    'WikiSigned', 'Escorts (out)', 'Escorts (in)',...
    'Twitter', 'Brightkite', 'Producers',...
    'Forum', 'Writers', 'Wikiquote',...
    'Bibsonomy', 'CiteULike'};
fig_xlabel = {'connections', 'words', 'emails',...
    ...
    'friends', 'links', 'papers',...
    'friends', 'relations', 'citations',...
    'interactions', 'sexual relations', 'sexual relations',...
    'follows', 'friends', 'works',...
    'posts', 'works', 'edits',...
    'tags', 'tags'};
directed = {'in', 'in', 'in',...
    'in', 'in', 'in',...
